...
sed -i "s|rmenai-blueprints/arduino|$name|g" pyproject.toml # Separator is |
sed -i "s/My Arduino template/$description/g" pyproject.toml # Remove description
sed -i "s/rmenai <rami.menai@outlook.com>/$author/g" pyproject.toml # Replace authors

# Change LICENSE
sed -i "s|rmenai-blueprints/arduino|$name|g" LICENSE # Separator is |

# Change SECURITY.md
sed -i "s/rmenai/$author/g" SECURITY.md

# Change .github/pull_request_template.md
sed -i "s|rmenai-blueprints/arduino|$repo|g" .github/pull_request_template.md
